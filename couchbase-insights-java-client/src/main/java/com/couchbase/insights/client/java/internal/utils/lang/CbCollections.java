...
package com.couchbase.insights.client.java.internal.utils.lang;
...
public class CbCollections {
  ...
  private static <K, V> void putUniqueKey(
    Map<K, V> map,
    K key,
    V value
  ) {
   ...
   * </pre>
   */
  public static <T1, T2> List<T2> transform(
    Iterable<T1> input,
   ...
   */
  public static <T extends Enum<T>> EnumSet<T> newEnumSet(
