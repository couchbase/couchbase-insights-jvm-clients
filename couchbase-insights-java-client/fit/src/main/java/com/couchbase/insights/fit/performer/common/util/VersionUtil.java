 ...
 */
package com.couchbase.insights.fit.performer.common.util;
...
public class VersionUtil {
  ...
  public static @Nullable String introspectSDKVersionJava() {
    return introspectSDKVersion("couchbase-insights-java");
  }

  public static @Nullable String introspectSDKVersionScala() {
    return introspectSDKVersion("couchbase-insights-scala");
  }

  public static @Nullable String introspectSDKVersionKotlin() {
    return introspectSDKVersion("couchbase-insights-kotlin");
  }
